class SuddenDeathLeftHexagon{
    constructor(){
        ...
        this.texture = PIXI.Texture.from('assets/png/sudden/hexagon/effect_exg_blue.png');
        this.sprites = [];
        for(let i = 0; i < 11; i++){
    ...
    t3(){
        ...
        this.sprites[0].x = 25;
        this.sprites[0].y = -250;
        this.back.addChild(this.sprites[0]);

        this.sprites[1].x = 200;
        this.sprites[1].y = -200;
        this.back.addChild(this.sprites[1]);

        this.sprites[2].x = 25;
        this.sprites[2].y = -150;
        this.back.addChild(this.sprites[2]);

        this.sprites[3].x = 200;
        this.sprites[3].y = -100;
        this.back.addChild(this.sprites[3]);
